...
vqvae = Hyperparams(
    ...
    restore_vqvae="logs/vq_vae/checkpoint_step_10392.pth.tar",     #####REMOTE_PREFIX + 'lass_audio/models/5b/vqvae.pth.tar',
)
...
upsampler_level_0 = Hyperparams(
    level=0,
    restore_prior=REMOTE_PREFIX + 'lass_audio/models/5b/prior_level_0.pth.tar'
)
...
upsampler_level_1 = Hyperparams(
    level=1,
    cond_res_scale=True,
    restore_prior=REMOTE_PREFIX + 'lass_audio/models/5b/prior_level_1.pth.tar'
)
...
prior_5b = Hyperparams(
    ...
    prime_loss_fraction=0.0,
    merged_decoder=True,
    restore_prior=REMOTE_PREFIX + 'lass_audio/models/5b/prior_level_2.pth.tar',
    fp16_params=True,
)
...
prior_5b_lyrics = Hyperparams(
    ...
    merged_decoder=True,
    restore_prior=REMOTE_PREFIX + 'lass_audio/models/5b_lyrics/prior_level_2.pth.tar',
    fp16_params=True,
    alignment_layer=68,
    alignment_head=2,
)
...
prior_1b_lyrics = Hyperparams(
    ...
    prime_loss_fraction=0.4,
    single_enc_dec=True,
    restore_prior=REMOTE_PREFIX + 'lass_audio/models/1b_lyrics/prior_level_2.pth.tar',
    fp16_params=False,
    alignment_layer=63,
    alignment_head=0,
)
