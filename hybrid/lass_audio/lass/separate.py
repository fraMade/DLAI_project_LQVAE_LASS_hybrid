...
def main(
    ...
    prior_2_path: str = 'logs/prior_drums/checkpoint_latest.pth.tar',#"logs/prior_drums/checkpoint_latest.pth.tar", , #"./logs/prior_drums/checkpoint_latest.pth.tar" ,#"./logs/lass-slakh-ckpts/prior_drums_44100.pth.tar", 
    ...
    max_sample_tokens: int = 1024, #512,#512,#1024,
    sample_rate: int = 22050, #44100, #22050,
    save_path: str = "./lass/results_subtest_hybrid",
    resume: bool = False,
