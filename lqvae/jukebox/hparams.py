...
vqvae = Hyperparams(
    ...
    # restore_vqvae='logs/lq_vae/checkpoint_step_9625.pth.tar',
)
...
HPARAMS_REGISTRY["vqvae_unsupervised"] = vqvae_unsupervised
...
small_vqvae = Hyperparams(
    ...
    m_conv = 1.0,
    dilation_growth_rate = 3,
    restore_vqvae='logs/lq_vae/checkpoint_step_4810.pth.tar',
    # width = 32,
    # depth = 4,
    # m_conv = 1.0,
    # dilation_growth_rate = 3,
