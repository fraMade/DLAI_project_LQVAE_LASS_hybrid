...
from jukebox.utils.io import wif
...
class DataProcessor():
    def __init__(self, hps):
        ...
        self.test_dataset = t.utils.data.random_split(self.test_dataset, [len_test, len(self.test_dataset)-len_test])[0]
        duration = 1 if hps.prior else 600

        hps.bandwidth = calculate_bandwidth(self.train_dataset, hps, duration=duration)
