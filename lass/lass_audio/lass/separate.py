...
def main(
    ...
    prior_1_path: str = "logs/prior_bass/checkpoint_latest_bass.pth.tar",  #"logs/prior_bass/checkpoint_latest.pth.tar",# #  #"./logs/prior_bass/checkpoint_latest.pth.tar", , # /checkpoint_latest.pth.tar,
    prior_2_path: str = "logs/prior_drums/checkpoint_latest_drums.pth.tar", 
    ...
    max_sample_tokens: int = 1024,#250, #512, #1024, #512,#512,#1024,
    sample_rate: int = 22050, #44100, #22050,
    save_path: str = "./lass/results_subtest_vqvae",
    resume: bool = False,
    ...
    **kwargs,
    ...
    separator = BeamsearchSeparator(
        ...
        num_beams=100,#100, #num_beams=100,
        **kwargs,
    )
