...
class JukeboxPrior(SeparationPrior):
    ...
    def get_sos(self) -> Any:
        # print(self._prior.start_token)
        return 0 #self._prior.start_token #0 #self._prior.start_token # DUMMY METHOD
...
class SparseLikelihood(Likelihood):
    ...
    def _normalize_matrix(self, sum_dist_path: str):
        ...
        # sum_dist = np.where(sum_dist > 0.0000000001, sum_dist, -10) ###########
